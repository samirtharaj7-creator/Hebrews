...
export const metadata: Metadata = {
  title: "Historical Background of Hebrews",
...
export default function BackgroundPage() {
  ...
  return (
    <main className="background-page hebrews-background-page">
      ...
      <section className="background-shell" aria-label="Hebrews background study">
        <div className="background-study">
          ...
          <section className="background-fact-grid" aria-label="Hebrews background facts">
