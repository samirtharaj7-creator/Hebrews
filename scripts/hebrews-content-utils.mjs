...
export const EXPECTED_VERSE_COUNTS = [14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25];

export function loadHebrews() {
  return EXPECTED_VERSE_COUNTS.map((expectedVerses, index) => {
    const chapterNumber = index + 1;
    const path = `content/hebrews/chapter-${String(chapterNumber).padStart(2, "0")}.json`;
