...
const links = [
  ...
  { href: "/hebrews/1", label: "Commentary", active: (pathname: string) => pathname.startsWith("/hebrews") },
...
export function SiteHeader() {
  ...
  return (
    <header className="reader-header no-print">
      <Link href="/" className="reader-brand" aria-label="Hebrews Commentary Home">
        ...
        <span className="reader-brand-text">
          <span className="reader-brand-strong">Hebrews Commentary</span>
        </span>
      </Link>
